    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign in to continue building amazing projects</p>
        </div>
          ...
          <CardContent>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <Button variant="outline" className="bg-transparent border-border hover:bg-accent">
