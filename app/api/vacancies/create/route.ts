...
export async function POST(req: Request) {
  try {
    const {  role, description, vacantTill,vacancies_url,createdBy } = await req.json();
    ...
    console.log("the created by field contains ",createdBy)
